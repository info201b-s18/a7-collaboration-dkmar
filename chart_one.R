...
survey_data_sorted <- survey_data %>%
  rename("class_standing" = What.is.your.current.class.standing.,
         "coding_experience" = How.would.you.describe.your.coding.programming.experience.) %>%
...
chart_one_function <- function(data) {
  # First factor class standing and experience level to rearrange the order of x-asix
